      ...
      {categories.map((category, index) => (
        <button
          ...
          className={` "font-bold inline-flex items-center 
            justify-center whitespace-nowrap rounded-md px-3
            py-1.5 text-sm ring-offset-background transition-all
            focus-visible:outline-none focus-visible:ring-2
            focus-visible:ring-ring focus-visible:ring-offset-2 
            disabled:pointer-events-none disabled:opacity-50
            data-[state=active]:bg-background data-[state=active]:text-foreground 
            data-[state=active]:shadow font-semibold " 
            ${selectedCategory === category ? "bg-primary-300 text-background" : "bg-primary-200 text-background/[0.6] hover:bg-primary-300 hover:bg-opacity-50 "}`}
