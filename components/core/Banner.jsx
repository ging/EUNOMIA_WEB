...
const Banner = React.forwardRef(({ className, ...props }, ref) => (
    ...
    "flex gap-8 justify-between items-center", className)}
      {...props} 
    />
  ))
...
const BannerContent = React.forwardRef(({ className, ...props }, ref) => (
    ...
    ref={ref}
    level="h1"
    className= {cn("h-fit md:min-h-[350px] my-12", className)}
    {...props} />
  ))
...
BannerImg.displayName = "BannerImg"
  ...
  export { Banner, BannerTitle, BannerDescription, BannerContent, BannerImg, BannerButton } ;