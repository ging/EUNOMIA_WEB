...
const badgeVariants = cva(
  "inline-flex px-3 py-1 items-center h-fit w-fit rounded-md uppercase border text-[14px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
